...
describe('Testing user login + member creation options', () => {
    ...
    it('Add myself as Member', ()=>{
        cy.screenshot('step1-add-self-user/step1-1-login_page')
        cy.get('form').within(() => {
            cy.get('input[name="identification"]').type('grupo10@uniandes.edu.co')
            cy.get('input[name="password"]').type('mMCDL6mWRAWyKUC')
        })
        cy.screenshot('step1-add-self-user/step1-2-login_info_complete')
        cy.get("#ember11").click()
        cy.wait(5000)
        cy.screenshot('step1-add-self-user/step1-3-dashboard')
        cy.visit('http://estudiantesmiso.space:2368/ghost/#/members')
        cy.wait(1000)
        cy.screenshot('step1-add-self-user/step1-4-member-page')
        cy.get('button[class="gh-btn gh-btn-green"]').click();
        cy.visit('http://estudiantesmiso.space:2368/ghost/#/members')
        cy.screenshot('step1-add-self-user/step1-5-member-page-with-new-member')
    ...
    it('Create New Member', ()=>{
        cy.screenshot('step2-add-new-member/step2-1-login_page')
        cy.get('form').within(() => {
            cy.get('input[name="identification"]').type('grupo10@uniandes.edu.co')
            cy.get('input[name="password"]').type('mMCDL6mWRAWyKUC')
        })
        cy.screenshot('step2-add-new-member/step2-2-login_info_complete')
        cy.get("#ember11").click()
        cy.wait(5000)
        cy.screenshot('step2-add-new-member/step2-3-dashboard')
        cy.visit('http://estudiantesmiso.space:2368/ghost/#/members')
        cy.wait(1000)
        cy.screenshot('step2-add-new-member/step2-4-member-page')
        ...
        cy.visit('http://estudiantesmiso.space:2368/ghost/#/members')
        cy.wait(3000)
        cy.screenshot('step2-add-new-member/step2-7-new-member-stored')
        // Delete member to restore the DB.
        cy.visit('http://estudiantesmiso.space:2368/ghost/#/members')
        cy.wait(5000)
        cy.screenshot('step2-add-new-member/step2-7-error')
        cy.get('a[class="ember-view gh-list-data"]').eq(0).click()
        cy.wait(1000)
        cy.get('button[class="gh-btn gh-btn-icon icon-only gh-btn-action-icon closed ember-view"]').click();
        cy.get('ul[class="dropdown gh-member-actions-menu dropdown-menu dropdown-triangle-top-right open fade-in-scale open ember-view"] li').eq(1).click();
    ...
    it('Create New Member with Excess Charaters', ()=>{
        cy.screenshot('step3-error-excess-characters/step3-1-login_page')
        cy.get('form').within(() => {
            cy.get('input[name="identification"]').type('grupo10@uniandes.edu.co')
            cy.get('input[name="password"]').type('mMCDL6mWRAWyKUC')
        })
        cy.screenshot('step3-error-excess-characters/step3-2-login_info_complete')
        cy.get("#ember11").click()
        cy.wait(5000)
        cy.screenshot('step3-error-excess-characters/step3-3-dashboard')
        cy.visit('http://estudiantesmiso.space:2368/ghost/#/members')
        cy.wait(1000)
        cy.screenshot('step3-error-excess-characters/step3-4-member-page')
        //
        cy.visit('http://estudiantesmiso.space:2368/ghost/#/members/new') 
        cy.wait(1000)
        cy.screenshot('step3-error-excess-characters/step3-5-new-member-page')
        cy.get('#member-name').type('Andres Ramirez', { force: true })
        cy.get('#member-email').type('aramirezr2@uniandes.edu.co', { force: true })
        ...
        cy.screenshot('step3-error-excess-characters/step3-6-new-member-excess-character-error')
        cy.wait(2000)
        ...
        cy.screenshot('step3-error-excess-characters/step3-7-new-member-excess-character-fixed')
        cy.wait(2000)
        cy.get('button[class="gh-btn gh-btn-primary gh-btn-icon ember-view"]').click();
        cy.wait(2000)
        cy.visit('http://estudiantesmiso.space:2368/ghost/#/members')
        cy.screenshot('step3-error-excess-characters/step3-8-new-member-stored')
        cy.wait(3000)
        cy.get('a[class="ember-view gh-list-data"]').eq(0).click()
        cy.wait(1000)
        cy.get('button[class="gh-btn gh-btn-icon icon-only gh-btn-action-icon closed ember-view"]').click();
    ...
    it('Edit Member', ()=>{
        cy.screenshot('step4-edit-member/step4-1-login_page')
        cy.get('form').within(() => {
            cy.get('input[name="identification"]').type('grupo10@uniandes.edu.co')
            cy.get('input[name="password"]').type('mMCDL6mWRAWyKUC')
        })
        cy.screenshot('step4-edit-member/step4-2-login_info_complete')
        cy.get("#ember11").click()
        cy.wait(5000)
        cy.screenshot('step4-edit-member/step4-3-dashboard')
        cy.visit('http://estudiantesmiso.space:2368/ghost/#/members')
        cy.wait(1000)
        ...
        cy.visit('http://estudiantesmiso.space:2368/ghost/#/members')
        cy.wait(3000)
        cy.screenshot('step4-edit-member/step4-4-member-page')
        // Open member created
        cy.get('a[class="ember-view gh-list-data"]').eq(0).click()
        cy.wait(1000)
        cy.screenshot('step4-edit-member/step4-5-old-member-view')
        cy.get('#member-name').clear()
        cy.get('#member-name').type('Andres Ramirez Restrepo', { force: true }) 
        cy.wait(1000)
        cy.screenshot('step4-edit-member/step4-6-old-member-edit-complete')
        cy.get('button[class="gh-btn gh-btn-primary gh-btn-icon ember-view"]').click();
        cy.wait(2000)
        cy.visit('http://estudiantesmiso.space:2368/ghost/#/members')
        cy.screenshot('step4-edit-member/step4-7-old-member-changes-stored')
        // Delete member to restore the DB.
        cy.wait(1000)
        cy.get('a[class="ember-view gh-list-data"]').eq(0).click()
        cy.wait(1000)
    ...
    it('Delete Member', ()=>{
        cy.screenshot('step5-delete-member/step5-1-login_page')
        cy.get('form').within(() => {
            cy.get('input[name="identification"]').type('grupo10@uniandes.edu.co')
            cy.get('input[name="password"]').type('mMCDL6mWRAWyKUC')
        })
        cy.screenshot('step5-delete-member/step5-2-login_info_complete')
        cy.get("#ember11").click()
        cy.wait(5000)
        ...
        cy.visit('http://estudiantesmiso.space:2368/ghost/#/members')
        cy.wait(3000)
        cy.screenshot('step5-delete-member/step5-4-member-page')
        //
        cy.get('a[class="ember-view gh-list-data"]').eq(0).click()
        cy.wait(1000)
        cy.screenshot('step5-delete-member/step5-5-delete-button')
        cy.get('button[class="gh-btn gh-btn-icon icon-only gh-btn-action-icon closed ember-view"]').click();
        cy.get('ul[class="dropdown gh-member-actions-menu dropdown-menu dropdown-triangle-top-right open fade-in-scale open ember-view"] li').eq(1).click();
        cy.wait(1000)
        cy.screenshot('step5-delete-member/step5-6-delete-modal')
        cy.get('button[class="gh-btn gh-btn-red gh-btn-icon ember-view"]').click();
        cy.wait(1000)
        cy.visit('http://estudiantesmiso.space:2368/ghost/#/members')
        cy.screenshot('step5-delete-member/step5-7-delete-confirm')
    })

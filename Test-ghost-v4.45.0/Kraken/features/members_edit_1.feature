...
Scenario: Editar exitosamente el correo de un usuario
    ...
    And I save screenshot "1-login_page" on "members-edit/success"
    ...
    And I save screenshot "2-dashboard" on "members-edit/success"

    Given I click on menu "Members"
    And I wait for 2 seconds
    And I save screenshot "3-members_list" on "members-edit/success"
    When I click on option "New member"
    And I save screenshot "4-new_member" on "members-edit/success"
    And I enter "$name_1" on "name" field
    And I enter "$email_1" on "email" field
    And I enter "$string_1" on "note" textArea
    And I wait for 1 seconds
    And I click on button "Save"
    And I save screenshot "5-member_saved" on "members-edit/success"
    And I wait for 2 seconds
    And I click on menu "Members"
    And I save screenshot "6-members_list" on "members-edit/success"
    Then I check if member "$$email_1" exists

    Given I click on member "$$email_1"
    And I wait for 1 seconds
    And I save screenshot "7-member_detail" on "members-edit/success"
    When I enter "$email_2" on "email" field
    And I click on button "Save"
    And I save screenshot "8-member_saved" on "members-edit/success"
    And I wait for 2 seconds
    
    And I click on menu "Members"
    And I save screenshot "9-members_list" on "members-edit/success"
    Then I check if member "$$email_1" doesn't exists
    And I check if member "$$email_2" exists

    Given I click on member "$$email_2"
    And I save screenshot "10-member_detail" on "members-edit/success"
    When I click on button "Actions"
    And I wait for 1 seconds
    And I save screenshot "11-member_actions" on "members-edit/success"
    And I click on button "Delete member"
    And I wait for 1 seconds
    And I save screenshot "12-member_delete_confirmation" on "members-edit/success"
    And I click on button "Delete member" on modal
    And I wait for 2 seconds
    And I save screenshot "13-members_list" on "members-edit/success"
